...
<div class="container" id="C1">
	<div class="container-fluid" id="C2">
	  <div class="row">
	    ...
	    <div class="col-5" id="C3"><h4>BlueBus Travels</h4></div>
	  </div>
	</div>
	...
	<div class="container-fluid" >
	  <div class="row" id="C4">
	    ...
	    <div class="col-3" ><h4 id="A1">BlueBus Ticket</h4></div>
	   ...
	   <div class="row" id="C6">
	    ...
	    <div class="col-3" ><h5>BBT483435698</h5></div>
	  ...
	  <div class="row" id="C7">
	   ...
	   <div>
	    <div class="row">
	     ...
	     <div class="col" id="m1"><h6>BlueBus Travels, Office No.7,<br>Mumbai, Maharashtra-400 001.</h6></div>
	   </div>
  </div>
  </div>
</div>
