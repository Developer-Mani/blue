  ...
  <a class="text-white ml-auto" href="Home.jsp">Log Out</a>
	...
	<div class="container">
		<div id="div1">
            ...
            <div class="form-group">
            	<input class="form-control ml-auto mr-auto mb-4" onKeyPress="if(this.value.length==2) return false;" type="number" name="age" required="" placeholder="Passenger Age" style="width: 250px;">
            </div>
            <div class="form-group">
            	<input class="form-control ml-auto mr-auto mb-4" onKeyPress="if(this.value.length==10) return false;" type="number" name="mobile" required="" placeholder="Mobile Number" style="width: 250px;">
            </div>
            <div class="form-group">
